...
export const getPrinters = async (findby) => {
  try {
    const url = `${END_POINT_APP}/v3/printers${findby}`;
...
export const getPrinter = async (printerId) => {
  try {
    const url = `${END_POINT_APP}/v3/printer?id=${printerId}`;
    const res = await axios.get(url);
    return res.data;
  } catch (error) {
    return error;
...
export const updatePrinter = async (data, id) => {
  try {
    const url = `${END_POINT_APP}/v3/printer/update`;
...
export const addPrinter = async (data) => {
  try {
    const url = `${END_POINT_APP}/v3/printer/create`;
