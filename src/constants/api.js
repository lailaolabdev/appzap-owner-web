...
const dev = "https://staging-v1.appzap.la"; // dev endpoint report & other [7079 - 7080]
 // dev endpoint bill & order [7070 - 7075]
...
export const END_POINT_SERVER_BUNSI = isProduction
  ? production_bunsi
  : production_bunsi;
// export const END_POINT_SERVER_JUSTCAN = "http://localhost:7070";
