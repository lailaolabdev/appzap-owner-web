...
export default function SettingList() {
  ...
  const data = [
    ...
    },
    {
      ...
      hidden: !hasMangeZone || storeDetail?.isStatusCafe,
    },
    {
      ...
      hidden: !hasMangeTable || storeDetail?.isStatusCafe,
    },
    {
    ...
    },
    {
      ...
      hidden: !hasMangeStock || storeDetail?.isStatusCafe,
    },
    {
    ...
    },
    {
      ...
      path: `/audio`,
      hidden: !hasMangeSound || storeDetail?.isStatusCafe,
    },
    {
    ...
    },
    {
      ...
      hidden: !hasMangeRole && profileRole !== "APPZAP_ADMIN",
    },
    {
      ...
      hidden: !hasMangeBanner || storeDetail?.isStatusCafe,
    },
    {
      ...
      path: `/PIN`,
      hidden: !hasMangePin || storeDetail?.isStatusCafe,
    },
    {
      ...
      hidden: !hasMangeDelivery || storeDetail?.isStatusCafe,
    },
  ...
  return (
    ...
    >
      ...
      >
        ...
        {hasClearHistory || (profileRole && hasClearHistory) ? (
