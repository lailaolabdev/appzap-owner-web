...
export default function PopUpDetailBillDebt({
  ...
  const [remainingAmount, setRemainingAmount] = useState(billDebtData?.remainingAmount);  //update
    ...
    <Modal show={open} onHide={onClose} size="md">
      ...
      >
        <div>
          ...
          <Form.Group>
            <Form.Label style={{ margin: "5px", color: "MidnightBlue" }}>(+) ເພີ່ມໜີ້ຄ້າງຊຳລະ</Form.Label>
            <Form.Control
          ...
          <Form.Group>
            <Form.Label style={{ margin: "5px", color: "MidnightBlue" }}>(-) ປ້ອນຈຳນວນທີ່ຕ້ອງການຊຳລະ</Form.Label>
            <Form.Control
