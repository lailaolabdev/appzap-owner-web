...
export default function PopUpPrintPromotion({
    ...
    const [promotionDiscountAndFreeReport, setPromotionDiscountAndFreeReport] = useState();
                    ...
                    <div ref={billRef}>
                        ...
                        <>
                            ...
                            <div className="grid grid-cols-[1fr_auto] gap-2 py-2 border-b font-medium">
                                ...
                                <div>
                                    {moneyCurrency(promotionReport?.[0]?.totalSaleAmount || 0)} {storeDetail?.firstCurrency}
                                </div>
                            </div>
                        </>
