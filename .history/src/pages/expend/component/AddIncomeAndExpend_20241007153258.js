              ...
              <Row>
                    ...
                    <Col xs={12} sm={12} md={6}>
                      <Form.Group>
                        ...
                        >
                          ...
                          <option value="SALARY">{t("employee_salary")}</option>
                          <option value="WELFARE">{t("welfare")}</option>
                          <option value="OPERATION">
                            {t("administrative_fees")}
                          </option>
                          <option value="OTHER">{t("otherr")}</option>
                ...
                <Col xs={12} md={6}>
                  ...
                  >
                    ...
                    <option value="DEBT">{t("debtt")}</option>
                    {/* <option value="OTHER">ອື່ນໆ</option> */}
                  </Form.Control>
                  <Form.Group>
                    <Form.Label style={{ fontWeight: "bold" }}>
                    ...
                    <Form.Control
                      ...
                      value={values.detail}
                      placeholder={t("input_expense_detail")}
                    />
                  </Form.Group>
                  <Form.Group>
                    <Form.Label style={{ fontWeight: "bold" }}>
