...
// Update orderStatus to accept `t` for translation
export const orderStatus = (status, t) => {
  switch (status) {
    case "WAITING":
      return "ອໍເດີເຂົ້າ"; // Static Lao string
    case "DOING":
      return t("cooking"); // Use the translation function for "cooking"
    case "SERVED":
      return t("served"); // Use translation for "served"
    case "CART":
      return t("ordering"); // Use translation for "ordering"
    case "FEEDBACK":
      return t("feedback"); // Use translation for "feedback"
    default:
      return t("cancel"); // Use translation for "cancel"
  }
};

export const orderStatusTranslate = (status, t) => {
