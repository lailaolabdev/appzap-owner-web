...
// Modify orderStatus to accept t as a parameter
export const orderStatus = (status, t) => {
  switch (status) {
    case "WAITING":
      return "ອໍເດີເຂົ້າ"; // Direct Lao string
    case "DOING":
      return t("cooking"); // Use translation for "cooking"
    case "SERVED":
      return t("served"); // Use translation for "served"
    case "CART":
      return t("ordering"); // Use translation for "ordering"
    case "FEEDBACK":
      return t("return"); // Corrected "return" translation
    default:
      return t("cancel"); // Use translation for "cancel"
  }
};

// This function does not require changes as it's for i18n keys
...
// Other utility functions (no changes required)
...
// ກຳນົດ ວັນທີປັດຈຸບັນ (Set current date in Lao)
