  ...
  return (
    <Router>
      <Switch>
        ...
        <MainLayout>
          {/* private routes */}
          <PrivateRoute exact path="/report/:storeId" component={Dashboard} />
          ...
          />
          <PrivateRoute exact path="/checkBill/:id" component={Notification} />
          <PrivateRoute
            exact
          ...
          />
          <PrivateRoute exact path="/messagerList" component={MessagerList} />

          <PrivateRoute exact path="/historyUse/:id" component={HistoryUse} />
          <PrivateRoute
            exact
            path="/reservations"
            component={ReservationList}
